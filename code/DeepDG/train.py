...
def get_args():
    ...
    parser.add_argument('--data_dir', type=str, default='D:\ML\Dataset\office31\\', help='data dir')
    ...
    parser.add_argument('--net', type=str, default='resnet50', help="featurizer: vgg16, resnet50, resnet101,DTNBase")
