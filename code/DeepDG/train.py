...
def get_args():
    ...
    parser.add_argument('--algorithm', type=str, default="ANDMask")
    ...
    parser.add_argument('--net', type=str, default='resnet18', help="featurizer: vgg16, resnet50, resnet101,DTNBase")
