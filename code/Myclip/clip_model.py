...
class ClipModel(object):
    ...
    def __init__(self, model_name='Vit-B/32', device='cuda', logger=None):
        ...
        self.ImageAdapter=Adapter(1024)
        self.ImageAdapter.train()
        self.ImageAdapter.to(device)
        clip.model.convert_weights(self.ImageAdapter)

        self.TxtAdapter = Adapter(1024)
        self.TxtAdapter.train()
        self.TxtAdapter.to(device)
        clip.model.convert_weights(self.TxtAdapter)
