...
def main(args):
    ...
    if args.mode == 'zs':  # zeroshot
        ...
        for name,para in clip.model.named_parameters():
        ...
        paras =list()
        paras.append({'params': clip.model.parameters()})
        paras.append({'params': clip.ImageAdapter.parameters()})
        ...
        optimizer = optim.Adam(paras, lr=args.lr, betas=(args.beta1, args.beta2), eps=args.eps, weight_decay=args.weight_decay)
