...
def get_args():
    ...
    parser.add_argument('--root', type=str, default='../../data/')  # root path of dataset
...
def main(args):
    ...
    itdata = ImageTextData(args=args,dataset=dataset, root=args.root, preprocess=clip.preprocess)
